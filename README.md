# RIF — Research Interchange Framework (anonymous review artifact)

Supplementary artifact for the EACL 2027 submission *"RIF: A Research Interchange Framework for Scientific Research in the Age of AI-Assisted Science"*.
...
| `demo/index.html` | Interactive demo: the same repository rendered for four profiles (reviewer / practitioner / student / full venue-paper view), with claim-level traceability and the full `.rif` source browsable in-page. **View it rendered at [/w/rif-anon-87AD/demo/index.html](https://anonymous.4open.science/w/rif-anon-87AD/demo/index.html)** (the `/r/` file browser shows sources only), or download and open locally - it is fully self-contained. |
